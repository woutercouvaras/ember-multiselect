(function() {
  ...
  Em.Handlebars.registerHelper('multi-select', function(options) {
    var hash = options.hash,
        types = options.hashTypes;
    return Em.Handlebars.helpers.view.call(this, Em.MultiSelectComponent, options);
  });
